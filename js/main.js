...
const eventsData = [{
        ...
        description: "احتفالية موسيقية تجمع أفضل الفنانين المحليين والدوليين من اجل تعزيز التبادل الثقافي و الفهم المشترك في ليلة لا تُنسى من الفن والألحان الرائعة.",
        featured: true
    },
    {
        id: 2,
    ...
    },
    {
        ...
        description: "  أكبر معرض للكتاب في المنطقة، يضم آلاف العناوين ودور النشر المحلية والعالمية يتيح فرصه للتعرف على أحدث الإصدارات في عالم الكتب.",
        featured: true
    },
    {
        id: 4,
    ...
    },
    {
        ...
        description: "عرض مسرحي كوميدي من تأليف وإخراج نخبة من الفنانين المحليين في ليله من الضحك المتواصل.",
        featured: false
    },
    {
        id: 6,
